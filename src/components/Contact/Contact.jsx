    ...
    <>
      <section className={style()} id='contact'>
        ...
        <div className={style('wrapper')}>
          ...
          <form className={style('form')} action='https://formsubmit.co/fede92a60dc3245cd5df6610d5d08563' method='POST'>
        ...
        <div className={style('social')}>
          ...
          <a className={style('social-btn')} href='https://www.instagram.com/stanleyyy_20/'>
            <i class='fa-brands fa-instagram'></i>
          </a>
          <a className={style('social-btn')} href='https://www.linkedin.com/in/dawid-stach-873620232/'>
            {' '}
